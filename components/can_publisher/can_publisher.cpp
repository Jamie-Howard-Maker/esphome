...
void CANPublisher::log_frame(uint32_t id, int16_t a, int16_t b, int16_t c, int16_t d, const uint8_t *raw) {
    ESP_LOGI("CAN",
...
void CANPublisher::send_frame(uint32_t id, int16_t a, int16_t b, int16_t c, int16_t d) {
    twai_message_t msg;
    msg.identifier = id;
    msg.extd = 0;
    msg.rtr = 0;
